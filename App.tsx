  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.greeting}>Hello, I'm Yujie Chen!</Text>
        <Text style={styles.info}>Student ID: n01678652</Text>
        <Text style={styles.info}>Program: Computer Programming</Text>
        <Text style={styles.info}>Trying to make small changes</Text>
